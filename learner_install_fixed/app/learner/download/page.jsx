...
export default function LearnerEntryPage() {
  ...
  useEffect(() => {
    ...
    // Register the learner service worker from the download page itself.
    // The worker is scoped to /learner, so the installed app can launch the
    // actual learner assessment route while the download page remains a
    // normal website.
  ...
  async function handleInstall() {
    ...
    // Chromium exposes the native installation prompt through this event.
    // The button is intentionally inert until the browser has supplied the
    // real install prompt, preventing the accidental page-refresh behavior.
        ...
        <section className="content">
          ...
          <aside className="install-panel" aria-label="CRL-App Learner installation">
            ...
            <button
              ...
              disabled={installed || isStandalone || !installReady}
              aria-label={installed || isStandalone ? "CRL-App Learner is installed" : "Install CRL-App Learner"}
            >
              <span className="button-icon" aria-hidden="true">
                {installed || isStandalone ? "✓" : "⇩"}
              </span>
              {installed || isStandalone ? "App Installed" : installReady ? "Install App" : "Preparing…"}
            </button>
