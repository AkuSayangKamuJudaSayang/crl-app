...
/*
 * Create the realtime client ahead of time so the socket and channel join are
 * already warm when the assessment actually starts. Callers may ignore the
 * result; a failure simply leaves polling as the transport.
 */
export function warmAssessmentRealtime() {
