...
# Keep the known-safe scoped fixes from v3.
...
# The generic lock pattern also occurs in Letter and Word handlers. Scope all
# comprehension-only rewrites to recordComprehension, preserving their guards.
