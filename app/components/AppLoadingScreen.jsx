...
export default function AppLoadingScreen() {
  ...
  useEffect(() => {
    ...
    /*
     * The boot screen belongs to cold starts only. Starting an assessment
     * reloads the route, and replaying a full branded splash on every in-app
     * navigation stacked it on top of the assessment's own "Starting
     * Assessment" overlay - three loading screens for one action. When the
     * navigation came from this same app the shell is already warm, so skip it.
     */
